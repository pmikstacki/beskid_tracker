...
export interface KanbanColumnHandleProps extends React.HTMLAttributes<HTMLDivElement> {
  cursor?: boolean
  asChild?: boolean
}
...
export interface KanbanItemHandleProps extends React.HTMLAttributes<HTMLDivElement> {
  cursor?: boolean
  asChild?: boolean
}
